...
public class C06_DoWhileLoop {
    ...
    public static void main(String[] args) {
        ...
        o sayiyi dikkate almayin ve “Negatif sayi giremezsiniz” yazdirip
        basa donun Kullanici 0’a bastiginda toplam kac pozitif sayi girdigini,
        ...
        do {
            System.out.println("Lutfen toplamak uzere tamsayi giriniz");
            sayi = scan.nextInt();
        ...
        System.out.println(negSayiAdedi + " adet negsatif sayi girdiniz ancak onlar toplama dahil edilmedi");
