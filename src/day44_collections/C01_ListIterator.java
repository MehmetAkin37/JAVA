...
public class C01_ListIterator {
    ...
    public static void main(String[] args) {
        ...
        while (li1.hasNext()) {
            ...
            // if ((Integer)li1.next()<basSinir || (Integer)li1.next()>bitSinir )}

            // Burada iki defa nex kullandigimiz zaman iterator her seferinde
            // iki defa ilerleyecek,son element kaldigi zaman iki defa ilerlemeye
            // calisip hata verecek.
