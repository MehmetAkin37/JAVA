...
public class C03_Date {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(tarih.getDayOfYear()); // 204   yilin kacinci gunu
        System.out.println(tarih.getDayOfWeek());    //  SATURDAY  gunu
        System.out.println(tarih.getMonthValue());   // 7  hangi ay oldugunu
        System.out.println(tarih.isLeapYear());      // false  artik yil degil

        LocalDate tarih9 = LocalDate.now();
