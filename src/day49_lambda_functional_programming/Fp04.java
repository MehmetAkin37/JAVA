...
public class Fp04 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ikiSayiArasindakiTumSayilarinRakamlarininToplami(13,11));
    ...
    public static int ikiSayiArasindakiTumSayilarinRakamlarininToplami(int x,int y){
