...
public class Fp03 {
    ...
    public static void main(String[] args) {
        ...
        //baslangiciAYadaSonuNOlanlariSil(liste);
        //baslangiciAYadaSonuNOlanlariSil2(liste);
        //uzunulugu8ile10ArasiVeOIleBiteniSil(liste);
        uzunulugu8ile10ArasiVeOIleBiteniYazdir(liste);
    ...
    public static void uzunlugaGoreYazdir(List<String> list) {
        ...
        //Comparator.comparing(): Sıralama koşulun belirtmek için kullanılır.
    }
   ...
   /* public static void bestenBuyukleriSil(List<String> list){
    ...
    // 1. Yol :
    /*public static void baslangiciAYadaSonuNOlanlariSil(List<String> list){
    ...
    // 2. Yol :
    /*public static void baslangiciAYadaSonuNOlanlariSil2(List<String> list){
   ...
   /* public static void uzunulugu8ile10ArasiVeOIleBiteniSil(List<String> list) {
    ...
    //8) Uzunluğu 8 ile 10 arası olan yada 'o' ile biten elemanları yazdiran bir method oluşturun.

    public static void uzunulugu8ile10ArasiVeOIleBiteniYazdir(List<String> list) {

        list.stream().filter(t -> (t.length() > 7 && t.length() < 11) || t.endsWith("o")).forEach(Utils::ayniSatirdaBosluklaYazdir);
