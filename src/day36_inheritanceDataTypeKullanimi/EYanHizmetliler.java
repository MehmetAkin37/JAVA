...
public class EYanHizmetliler extends BMuhasebe {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(yh1.gunlukMesai);  // 8 Muhasebeden aldik
        System.out.println(yh1.saatUcreti);   // 10 Muhasebeden aldik

        yh1.maas();           //  YanHizmetlilerden aldik
        yh1.ozelSigorta();    //  Muhasebeden aldik
        yh1.sigorta();       //   Personelden aldik

        System.out.println(yh1.isim);           //  Personelden aldik
        System.out.println(yh1.soyIsim);        //  Personelden aldik
        System.out.println(yh1.departmant);     //  Personelden aldik
        //System.out.println(yh1.issizlikSigorta);  Muhasebe ve Personelde bulamadigimiz icin CTE
